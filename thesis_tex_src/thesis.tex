...
% Sonams Added Packages
\usepackage[colorlinks = true,
            linkcolor = blue,
            urlcolor  = blue,
            citecolor = blue,
            anchorcolor = blue]{hyperref}    % Makes ToC clickable
            

\usepackage{braket}  % Braket Notation
\usepackage{tikz} % figures
\usetikzlibrary{arrows,positioning} % figures
\usepackage{subcaption} % subfigures
\usepackage[linesnumbered,ruled]{algorithm2e} % Algorithm tables
\usepackage{blkarray}  % Block Arrays
\usepackage{multirow} % multiple rows
\usepackage{ragged2e} % tabling formatting
